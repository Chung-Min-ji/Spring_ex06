...
<script type="text/javascript">
    $(function(){
        ...
        //------- 첨부파일 보여주기
        (function (){
            console.debug("show attached file IIFE invoked...");
        ...
        //-------- x 버튼 클릭 이벤트 : 화면에서만 삭제
        // 실제 데이터는, 게시물의 최종 수정 버튼을 클릭했을 때 삭제됨.
